    ...
    public partial class SdkPlugin : ErpPlugin
    {
        private static void Patch20201221(EntityManager entMan, EntityRelationManager relMan, RecordManager recMan)
        {
            #region << ***Update entity*** Entity name: role >>
            {
                ...
                // caller who has not yet authenticated; ERPService.cs establishes that they do not - the
                // sign-in path hydrates roles under a system scope - and no longer seeds that grant. Because
                // plugin patches run after provisioning, retaining it here reopened F17 on every installation
