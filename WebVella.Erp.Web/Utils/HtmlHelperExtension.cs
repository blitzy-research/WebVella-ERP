...
namespace WebVella.Erp.Web
{
	public static class WvTaghelperExtension
	{
		...
		/// model with <c>JavaScriptEncoder</c> instead, as <c>Pages/ckeditor/ImageFinder.cshtml.cs</c> does.
		/// No helper is published for it - review finding API-01 - because a single sink does not justify
		/// widening this assembly's public API surface for every consumer.
		///
