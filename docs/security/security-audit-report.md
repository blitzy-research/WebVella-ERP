...
| **LOCATION** | `WebVella.Erp/Api/Models/AutoMapper/Profiles/JobProfile.cs`, `WebVella.Erp/Database/DbRelationRepository.cs`, `WebVella.Erp/Database/DbEntityRepository.cs` and `WebVella.Erp.Plugins.SDK/Services/CodeGenService.cs`. The binder introduced to close them is `WebVella.Erp/Api/Models/ErpSerializationBinder.cs`. |
