...
| Control | State |
| --- | --- |
| Configuration provider chain | JSON file, then user secrets in Development, then **environment variables last** so an operator value always wins. Present at all four builder sites: `WebVella.Erp.Web/ErpMvcExtensions.cs:L145`, `WebVella.Erp.Site/Startup.cs:L61`, `WebVella.Erp.Site.Project/Startup.cs:L51`, `WebVella.Erp.ConsoleApp/Program.cs:L51` |
